...
- 여러 사건이 있으면 사용자의 현재 감정과 가장 직결된 **하나의 상태나 사건**만 선택
- 두 사건을 "~하고, ~" 형태로 나열하지 않기
- 30자 이내
...
**입력:**
"작년에 취업했는데 무릎 수술 때문에 퇴사했어. 다시 2주 전부터 이력서 넣는데 연락이 안 와. 친구들은 다 취업했는데 나만 이러고 있어서 자괴감 들어."
...
```json
{
  ...
  "fact": "이력서를 넣은 지 2주가 됐고 아직 연락이 없는 상태다",
  "interpretation": "연락이 없는 것이 내 무능함의 증거라는 판단",
  "counter_hints": [
    "수술이라는 불가피한 사정",
    "2주는 짧은 시간",
    "친구들과 출발점이 다름"
