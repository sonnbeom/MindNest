...
@Component
public class IntakeAnalysisPrompt implements PromptTemplate {
    ...
    @Value("classpath:${llm.anthropic.prompt.intake-analysis}")
    ...
    public List<LlmMessage> buildMessages(String userInput) {
        String renderedUser = render(Map.of("intakeText", userInput));
        return List.of(
